...
export default defineConfig({
        ...
        vite: {
          resolve: {
            alias: [
              ...
              { find: /^#claude\//, replacement: path.resolve(__dirname, 'claude/') + '/' },
              { find: '#claude', replacement: path.resolve(__dirname, 'claude/index.ts') },
              { find: /^#claude-installer\//, replacement: path.resolve(__dirname, 'claude-installer/') + '/' },
              { find: '#claude-installer', replacement: path.resolve(__dirname, 'claude-installer/index.ts') },
            ],
          },
  ...
  resolve: {
    alias: {
      ...
      '#claude': path.resolve(__dirname, './claude'),
